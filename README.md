...
|:---:|:---:|:---:|
| ![Topology](./prints/topologia.png) | ![Dashboard](./prints/GroundControl.png) | ![NaveMae](./prints/naveMae.png) |
| *Network Topology running in CORE* | *Real-time telemetry and control* | *Mothership real-time orders* |
---
